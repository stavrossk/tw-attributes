...
var watchSymbols = ["strength", "accuracy", "intellect", "innovation", "stamina"];
...
var t = new twitter({
    consumer_key: 'your_data',           // <--- FILL ME IN
    consumer_secret: 'your_data',        // <--- FILL ME IN
    access_token_key: 'your_data',       // <--- FILL ME IN
    access_token_secret: 'your_data'     // <--- FILL ME IN
});
